...
class BaseExtractor(Transformer, HasInputCol, HasOutputCol, HasKeepInputData, HasPathCol,
          DefaultParamsReadable, DefaultParamsWritable, HasNumPartitions, HasPageCol,
    ...
    def transform_udf(self, document, params=None):
        ...
        if document.exception != "":
            return ExtractorOutput(path=document.path,
                                  data="",
                                  type="extractor",
